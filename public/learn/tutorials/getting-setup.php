...
<p>There's no one right answer to the question of which browser you should be using. There are four obvious contenders: Safari, Chrome, Firefox and Internet Explorer.</p>

<h3>Safari</h3>

<p><a href="http://www.apple.com/safari/">Safari</a> is the most popular choice, especially because the shipping version of Safari has a great set of developer tools. There is a full featured debugger, profiler, and HTTP monitor. To access the inspector, you'll need to check the "Show Develop menu in the menu bar" checkbox in the Advanced section of the preferences.</p>

<center><img src="images/develop1.png" alt="enable safari developer menu" /></center>

<p>Safari does have other advantages. First, it's a faster browser than Firefox, especially at JavaScript. Although both browsers are fast, when you're in the rapid development cycle of programming, refreshing, and testing your changes, the extra speed boost can be useful. Second, and perhaps more importantly, Safari has a slightly different security model than Firefox when it comes to XMLHTTPRequests and the same origin policy.</p>
...
<p>If you use another text editor, and have written or would like to write an add-on for it to support Objective-J, we strongly encourage it and will list it here. Get in touch with us on the <a href="http://groups.google.com/group/objectivej">mailing list</a>.</p>
...
<p>If you have suggestions for improvements to this guide, or if you have questions that haven't been answered here, please let us know in the <a href="/discuss/list.php">mailing list or IRC channel</a>.</p>
