...
<p>Cappuccino is hosted on <a href="http://github.com/280north/cappuccino">Github</a> using the <a href="http://git-scm.com/">Git</a> version control system. You can get the code with the following command:</p>
<code>
...
<p>You can also download the latest source code as a <a href="http://github.com/280north/cappuccino/zipball/master">zip file</a> or <a href="http://github.com/280north/cappuccino/tarball/master">tarball</a>. These links go to the top of the tree, but using Github, you can find any specific revision on any branch and download either file.</p>

<p>For help getting set up with the build tools and checking out the source code, follow <a href="http://wiki.github.com/280north/cappuccino/getting-and-building-the-source">this tutorial</a>.</p>

<h2>Reporting Bugs</h2>

<p>We use the <a href="http://github.com/280north/cappuccino/issues">GitHub issue tracker</a> to report and follow bugs in Cappuccino.  If you think you've found a problem in Cappuccino, you can always ask about it on the mailing list or in the IRC chat room, or you can search GitHub.  If you've discovered a new bug, report it!</p>
